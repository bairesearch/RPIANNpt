...
# groups to plot
graphedDatasets = [True, True, True, True, True, True, True]
...
group_labels = ["useClassificationLayerLoss", "useEmbeddingLayerLoss", "numberOfLayers=9 numberOfSublayers=2 useRecursiveLayers", "numberOfLayers=1 numberOfSublayers=2", "numberOfLayers=9 useRecursiveLayers", "numberOfLayers=9", "numberOfLayers=1"]
