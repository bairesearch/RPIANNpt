...
def createModel(dataset):
	...
	if(printRPIANNmodelProperties):
		...
		print("\t useInputProjection = ", useInputProjection)
		...
		print("\t ---")
		print("\t useProjectionAutoencoder = ", useProjectionAutoencoder)
		if(useProjectionAutoencoder):
			print("\t\t inputProjectionAutoencoder = ", inputProjectionAutoencoder)
			print("\t\t inputProjectionAutoencoderIndependent = ", inputProjectionAutoencoderIndependent)
			print("\t\t targetProjectionAutoencoder = ", targetProjectionAutoencoder)
			print("\t\t targetProjectionAutoencoderIndependent = ", targetProjectionAutoencoderIndependent)
			print("\t\t projectionAutoencoderPretrainEpochs = ", projectionAutoencoderPretrainEpochs)
			print("\t\t projectionAutoencoderWarmupEpochs = ", projectionAutoencoderWarmupEpochs)
			print("\t\t projectionAutoencoderDenoisingStd = ", projectionAutoencoderDenoisingStd)
		print("\t ---")
		...
		if(useNLPDataset):
			print("\t\t bertModelName = ", bertModelName)
			print("\t\t bertNumberTokenTypes = ", bertNumberTokenTypes)
			print("\t\t contextSizeMax (sequenceLength) = ", contextSizeMax)
			print("\t\t useInputPretrainedBertEmbedding = ", useInputPretrainedBertEmbedding)
			print("\t\t useTargetPretrainedBertEmbedding = ", useTargetPretrainedBertEmbedding)
			print("\t\t inputEmbeddingSize = ", inputEmbeddingSize)
			print("\t\t targetEmbeddingSize = ", targetEmbeddingSize)
			print("\t\t NLPpadTokenID = ", NLPpadTokenID)
